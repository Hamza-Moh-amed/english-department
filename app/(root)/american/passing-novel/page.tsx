  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8 space-y-4 md:space-y-12 max-w-full sm:max-w-[600px] md:max-w-[800px]">
        ...
        {/* Article Section */}
        <section id="encounter" className="space-y-8">
          <article className="prose max-w-none text-left md:text-justify">
            ...
            <p className="text-lg">
              ...
              other unfavourable circumstances. How savagely she had clawed
              those boys the day they had hooted her parent and sung a derisive
              rhyme, of their own composing, which pointed out certain
              eccentricities in his careening gait! And how deliberately she
              had—
            </p>
            <p className="text-lg">
            ...
            <p className="text-lg">
              ...
              herself, accede to that. Nor would she assist Clare to realize her
              foolish desire to return for a moment to that life which long ago,
              and of her own choice, she had left behind her.
            </p>
            <p className="text-lg">
            ...
            <p className="text-lg">
              Sheets upon thin sheets of it. And ending finally with, "and it's
              your fault, 'Rene dear. At least partly. For I wouldn't now,
              perhaps, have this terrible, this wild desire if I hadn't seen you
              that time in Chicago….”
            </p>
            <p className="text-lg">
              Brilliant red patches flamed in Irene Redfield's warm olive
              cheeks.
            </p>
            <p className="text-lg">
