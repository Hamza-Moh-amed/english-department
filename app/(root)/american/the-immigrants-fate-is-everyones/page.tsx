        ...
        <div className="main-content">
          ...
          <section id="article" className="section-content">
            ...
            <article className="article-block">
              <p className="article-paragraph">
                ...
                Vietnamese, an Asian and a refugee. I do not have to choose
                among these identities, despite those who would insist that I
                do. On one end of the spectrum, well-meaning people who invoke
                ...
                given just two choices, know that it’s a trick. Even my
                3-year-old son understands this. When I ask him whether he will
                grow up to be Batman or a fireman, he says, “Batman and a
                fireman!” And why not?
              </p>
              <p className="article-paragraph">
                Childhood is marked by curiosity, imagination’s endless play and
                a disregard for all boundaries. As we age, we learn to respect
                some borders. But we also stiffen, becoming arthritic in both
                body and mind. What’s the proper balance between believing that
                we should explore everywhere, take in everything, and the
                sensible idea that perils exist, that some strangers really mean
                us harm?
              </p>
              <p className="article-paragraph">
                ...
                often asked this question. To the country’s discredit, the
                answers have sometimes involved closing the borders, excluding
                those of certain races or nations, and deporting people with a
                reasonable claim to live here.
              </p>
              <p className="article-paragraph">
                ...
                its freedom, America decided to rule it, waging a war and
                killing hundreds of thousands of Filipinos in the process.
                Colonizing the Philippines resulted in an odd quirk of
                immigration. Because they were governed by the U.S., Filipinos
                could circumvent the exclusion laws that had almost completely
                eliminated Asian immigration from 1882 until the 1950s. Being a
                colonized American ward was how Bulosan found his way to this
                country and became a celebrated writer.
              </p>
              <p className="article-paragraph">
                His career peaked with his 1946 classic, *America Is in the
                Heart*. The book, like his essay, explored how his adopted
                nation sometimes welcomed immigrants and sometimes hated them.
                Bulosan’s writing and life revealed that contradiction. In his
                essay, he wrote about how “the American Dream is only hidden
                away, and it will push its way up and grow again.” But his life
                ended in the American nightmare. The FBI investigated him for
                being a communist labor activist, and he was afflicted with
                alcoholism and tuberculosis. He died of exposure on the steps of
                Seattle City Hall in 1956, his literary reputation already
                fading. This, too, is an immigrant story.
              </p>
              <p className="article-paragraph">
                As a writer and as someone who also comes from a country where
                the U.S. fought a bloody war, I often think of Carlos Bulosan.
                ...
                their practice, both of which exist at the same time. He reminds
                us that a nation without immigrants is a country without
                imagination, a state that turns, eventually, into stagnation.
                Without immigrants (and refugees and slaves), we would be a much
                paler and older country, burdened with bland food, boring music
                and stale language. Imagine an America with no jazz or salsa, no
                rock music or spring rolls, no rap or wraps. Would you want to
                live there?
              </p>
              <p className="article-paragraph">
                ...
                that no one is ever three-fifths of a human being, to believe
                that America should not be only white and is not always right.
                So when Donald Trump said he wanted to build a wall to keep
                Mexicans out, Mexican Americans responded by batting at piñatas
                with his face on them.
              </p>
              <p className="article-paragraph">
                Even before Trump can build that wall to keep our neighbors out,
                we must say, as Reagan did to Gorbachev, “Tear down this wall.”
                If John F. Kennedy could say to Berliners that he was one of
                them, then all Americans can say the same to immigrants. If we
                want to be great, we must create and re-create the U.S., over
                and over, a job for which immigrants are ideally suited. Their
                fate is America’s as well. Here, too, it’s worth remembering
                what Bulosan wrote of immigrants: “We are the mirror of what
                America is ... If we fail, then America fails.” But whose
                America and what America are we speaking about?
              </p>
              <p className="article-paragraph">
                My America opens its arms to the world rather than sells the
                world its arms. My America has a capacious hunger and the
                humility to wonder if it is right. My America speaks many
                languages and knows when to hold its tongue. But I know that
                another America exists, a more fearful and dangerous one. If
                that America wins, then we and the world lose.
              </p>
            </article>
          </section>
          ...
          <section id="analysis" className="section-content">
            ...
            <div className="section-block">
              ...
              <p className="section-subtitle">
                1. The Complexity of Immigrant Identity
              </p>
              <p className="section-paragraph">
                Viet Thanh Nguyen’s *The Immigrant’s Fate is Everyone’s*
                explores the multifaceted nature of immigrant identity,
                challenging the notion that individuals must choose between
                their cultural heritage and their national identity. Nguyen
                asserts that he is simultaneously an immigrant, a human being,
                an American, a Vietnamese, an Asian, and a refugee. This refusal
                to simplify his identity reflects a broader critique of societal
                pressures to conform to singular, monolithic labels. Nguyen’s
                perspective is particularly poignant in the context of American
                discourse on immigration, where immigrants are often reduced to
                stereotypes or forced to assimilate into a dominant culture.
              </p>
              ...
              <p className="section-paragraph">
                This assertion underscores the importance of embracing
                complexity in discussions of identity, rejecting the binary
                thinking that often dominates political and social debates.
                Nguyen’s argument resonates with broader academic discussions on
                intersectionality, which emphasize the interconnectedness of
                various social identities and the ways in which they shape
              ...
              <p className="section-paragraph">
                ...
                example of Carlos Bulosan, a Filipino immigrant writer whose
                work captured the contradictions of the American Dream.
                Bulosan’s writing, Nguyen argues, was an act of imagination that
                called on Americans to confront the gap between their ideals and
                their actions. This imaginative act is crucial for immigrants,
                who must navigate the tension between the promise of America and
                the reality of exclusion and discrimination.
              </p>
              <p className="section-quote">
                Quote:
                <em className="section-quote-em">
                  "His writing was an act of the imagination, calling on
                  Americans to believe in the best of their rhetoric and not the
                  worst of their practice."
                </em>
              </p>
              <p className="section-paragraph">
                ...
                deeply human one, shaped by stories, dreams, and aspirations.
                This perspective challenges readers to think beyond policy
                debates and consider the lived experiences of immigrants.
              </p>

              {/* Analysis Point 3: The Contradictions of the American Dream */}
              <p className="section-subtitle">
                3. The Contradictions of the American Dream
              </p>
              <p className="section-paragraph">
                ...
                example of Carlos Bulosan to illustrate this contradiction,
                noting that while Bulosan celebrated the American Dream in his
                writing, his life ended in tragedy, marked by poverty, illness,
                and marginalization.
              </p>
              <p className="section-quote">
                Quote:
              ...
              <p className="section-subtitle">
                4. The Immigrant as a Mirror of America
              </p>
              <p className="section-paragraph">
              ...
              <p className="section-paragraph">
                ...
                just as an issue of border control but as a reflection of
                national values and identity.
              </p>

              {/* Analysis Point 5: The Role of Immigrants in Shaping America */}
              <p className="section-subtitle">
                5. The Role of Immigrants in Shaping America
              </p>
              <p className="section-paragraph">
                Nguyen emphasizes the transformative role that immigrants have
                played in shaping American culture, politics, and society. He
                argues that without immigrants, America would be “a much paler
                and older country, burdened with bland food, boring music and
                stale language.” This assertion highlights the contributions of
                immigrants to the nation’s cultural and social fabric,
                challenging narratives that portray immigrants as a threat or a
                burden.
              </p>
              <p className="section-quote">
                Quote:
              ...
              <p className="section-subtitle">
                6. The Political Implications of Immigration
              </p>
              <p className="section-paragraph">
              ...
              <p className="section-paragraph">
                ...
                policy, framing it as a question of national identity and
                values. Nguyen’s call to “tear down this wall” serves as a
                powerful metaphor for the need to embrace inclusivity and reject
                exclusionary politics.
              </p>

              {/* Analysis Point 7: The Dual Nature of America */}
              <p className="section-subtitle">7. The Dual Nature of America</p>
              <p className="section-paragraph">
                Nguyen concludes his essay by reflecting on the dual nature of
                America, which he describes as both inclusive and exclusionary.
                He contrasts his vision of an America that “opens its arms to
                the world” with a more “fearful and dangerous” America that
                seeks to close itself off. This duality reflects the broader
                tension in American society between its ideals of freedom and
                equality and its history of exclusion and discrimination.
              </p>
              <p className="section-quote">
                Quote:
                <em className="section-quote-em">
              ...
              <p className="section-paragraph">
                ...
                America they want to embrace, framing the debate over
                immigration as a choice between inclusivity and exclusion.
              </p>
            </div>
          </section>
          ...
          <section id="qna" className="section-content">
            ...
            <ol className="section-list">
              ...
              {/* Question 2 */}
              <li className="section-question">
                How does Nguyen use the example of Carlos Bulosan to illustrate
