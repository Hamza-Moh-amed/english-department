    ...
    <main className="page-container">
      <div className="content-layout">
        ...
        <div className="main-content">
          {/* Title */}
          <PageTitle title="English to Arabic Translation" />
              ...
              <article className="bg-white p-8 rounded-lg shadow-md border border-gray-200 w-full md:w-4/5 lg:w-full">
                ...
                <div dir="ltr">
                  ...
                  <p className="text-lg leading-relaxed text-gray-900 text-left">
                    ...
                    the Strip to address the humanitarian crisis facing the
                    people of Gaza. The Malaysian prime minister praised Egypt's
                    tireless efforts to support the Palestinian people, stop the
                    bloodshed, and restore calm to the region. Meanwhile, both
                    leaders affirmed the need to intensify international efforts
                    to establish the Palestinian state along the borders of June
                    4, 1967, with East Jerusalem as its capital. They stressed
                    that this objective is the only guarantee for achieving
                    lasting peace in the region and ensuring stability and
                    prosperity for its peoples. Gaza is currently witnessing a
                    relative calm under a ceasefire, brokered by Egypt, Qatar,
                    and the US.
                  </p>
                </div>
                ...
                <div dir="rtl">
                  ...
                  <p className="text-lg leading-relaxed text-gray-900 text-right">
                    ...
                    الجمعة، تناول السيسي وإبراهيم جهود مصر لتنفيذ اتفاق وقف
                    إطلاق النار في قطاع غزة بالتعاون مع دولة قطر والولايات
                    المتحدة. كما سلطت المكالمة الضوء على مساعي مصر لتوصيل
                    المساعدات الإنسانية إلى القطاع لمواجهة الأزمة التي يعاني
                    منها سكان غزة. أشاد رئيس الوزراء الماليزي بالجهود الدؤوبة
                    التي تبذلها مصر لدعم الشعب الفلسطيني، ووقف سفك الدماء،
                    وإعادة الهدوء إلى المنطقة. في الوقت نفسه، أكد الزعيمان ضرورة
                    تكثيف الجهود الدولية لإقامة الدولة الفلسطينية على حدود 4
                    يونيو عام 1967 وعاصمتها القدس الشرقية. كما شددا على أن هذا
                    الهدف هو الضمان الوحيد لتحقيق سلام دائم في المنطقة وضمان
                    الاستقرار والازدهار لشعوبها. وتشهد غزة حاليًا هدوءًا نسبيًا
                    تحت وقف إطلاق النار الذي تم التوسط فيه من قبل مصر وقطر
                    والولايات المتحدة.
                  </p>
                </div>
              </article>
                ...
                <div className="space-y-4">
                  <ul className="list-disc space-y-2 pl-6 text-lg text-gray-900">
                    ...
                    <li>
                      ...
                      translated as <em>"تهجير"</em> instead of <em>"نزوح"</em>{" "}
                      to reflect forced removal.
                    </li>
                    <li>
                      <strong>Fixed Expressions:</strong> "Stop the bloodshed"
                      was translated as <em>"وقف سفك الدماء"</em> instead of a
                      literal translation, ensuring a natural flow.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <article className="bg-white p-8 rounded-lg shadow-md border border-gray-200 w-full md:w-4/5 lg:w-full">
                <div dir="ltr">
                  ...
                  <p className="text-lg leading-relaxed text-gray-900 text-left">
                    ...
                    University students held in custody for the past eight
                    months on suspicion of involvement in on-campus clashes with
                    security forces, the Freedom to the Brave campaign said in a
                    statement issued Thursday. The students were reportedly
                    cleared of the charges after the prosecution’s
                    investigations showed they had no relationship to the
                    violent events that occurred on January 16, according to the
                    campaign’s statement. The detained students faced murder
                    charges for the death of fellow student Sherif al-Sawy and
                    the attempted murder of 27 others, as well as protesting
                    without permission and vandalizing university property.
                ...
                <div dir="rtl">
                  <h2 className="text-3xl font-semibold text-gray-800 mb-6 text-center">
                    النيابة العامة تفرج عن 40 طالباً من جامعة القاهرة معتقلين
                    منذ ثمانية أشهر
                  </h2>
                  <p className="text-lg leading-relaxed text-gray-900 text-right">
                    أصدرت النيابة العامة قراراً بالإفراج عن 40 طالباً من جامعة
                    القاهرة كانوا قيد الاحتجاز لمدة ثمانية أشهر، وذلك بتهمة
                    تورطهم في اشتباكات داخل الحرم الجامعي مع قوات الأمن، وفقاً
                    لبيان صادر عن حملة "الحرية للجدعان" يوم الخميس. ووفقاً
                    للبيان، فقد تم تبرئة الطلاب من التهم بعد أن كشفت تحقيقات
                    النيابة عدم ارتباطهم بالأحداث العنيفة التي وقعت في 16 يناير.
                    وُجهت إلى الطلاب المحتجزين اتهامات تتعلق بالقتل في واقعة
                    وفاة زميلهم شريف الصاوي، بالإضافة إلى محاولة قتل 27 شخصاً
                    آخرين، والاحتجاج دون تصريح، وتخريب ممتلكات الجامعة. وخلال
                    فترة احتجازهم التي امتدت لثمانية أشهر، تم تمديد احتجازهم
                ...
                <div className="space-y-4">
                  <ul className="list-disc space-y-2 pl-6 text-lg text-gray-900">
                    ...
                    <li>
                      ...
                      present tense (تأمر), while the <em>body text</em>{" "}
                      maintains past tense for better flow.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <em>"معتقلين"</em> instead of <em>"محتجزين"</em> for
                      impact.
                    </li>
                    <li>
                      <strong>Fixed Expressions:</strong> "تمت تبرئتهم" was
                      chosen instead of "يتم تبرئتهم" for proper Arabic syntax.
                    </li>
                  </ul>
                </div>
              </div>
