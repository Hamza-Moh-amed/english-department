          ...
          <div className="overflow-x-auto bg-white rounded-md shadow-md p-4 sm:p-6">
            <table className="w-full table-auto">
              <tbody>
                ...
                <tr>
                  <td colSpan={2} className="px-4 py-2 text-gray-700">
                    <em>
                      ...
                      assessment. These five principles form the foundation for
                      designing tests that are accurate, fair, and supportive of
                ...
                <tr>
                  <td className="px-4 py-2 font-medium text-gray-800">Cost</td>
                  <td className="px-4 py-2 text-gray-700">
                ...
                <tr>
                  <td className="px-4 py-2 font-medium text-gray-800">Time</td>
                  <td className="px-4 py-2 text-gray-700">
                    <ul className="list-disc ml-4">
                      <li>
                        The test should adhere to appropriate time constraints.
                      </li>
                      <li>
                        It should be neither too long (causing fatigue) nor too
                        short (failing to capture enough information).
                      </li>
                      <li>
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 text-gray-700">
                    <ul className="list-disc ml-4">
                      ...
                      <li>
                        Example: A computer-interaction test may be impractical
                        in remote areas with limited skills.
                      </li>
                    </ul>
                  </td>
                </tr>
                ...
                <tr>
                  <td colSpan={2} className="px-4 py-2 text-gray-700">
                    ...
                    <ul className="list-disc ml-4">
                      ...
                      <li>The test demands a non-operational computer lab.</li>
                      <li>
                ...
                <tr className="border-b">
                  <td colSpan={2} className="px-4 py-2 text-gray-700">
                    <ul className="list-disc ml-4">
                      ...
                      <li>The test should focus solely on the target skill.</li>
                      <li>
                ...
                <tr className="border-b">
                  <td colSpan={2} className="px-4 py-2 text-gray-700">
                    <ul className="list-disc ml-4">
                      ...
                      <li>
                        A reliable test yields consistent results over repeated
                        administrations.
                      </li>
                      <li>
                        It is the consistency of results that is important, not
                ...
                <tr>
                  ...
                  <td className="px-4 py-2 text-gray-700">
                    <ul className="list-disc ml-4">
                      ...
                      <li>
                        Inter-rater Reliability: Differences in scoring between
                        raters.
                      </li>
                      <li>
                ...
                <tr>
                  <td colSpan={2} className="px-4 py-2 text-gray-700">
                    <ul className="list-disc ml-4">
                      <li>
                        Refers to the influence that testing exerts on teaching
                        and learning.
                      </li>
                      ...
                      <li>
                        ...
                        <ul className="list-decimal ml-4">
                          <li>
                            Occurs when tests narrow the curriculum and increase
                            student anxiety, detracting from a holistic learning
                            experience.
                          </li>
                          <li>
                            Note: Even a test with sound internal qualities may
                            generate negative washback if its influence is
                            detrimental.
                          </li>
                        </ul>
                      </li>
